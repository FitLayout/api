...
public class RectangularImpl
{
	...
	public RectangularImpl(int x1, int y1, int x2, int y2)
	{
		this.x1 = x1;
		this.x2 = x2;
		this.y1 = y1;
	...
	public RectangularImpl(RectangularImpl src)
	{
		this.x1 = src.x1;
		this.x2 = src.x2;
		this.y1 = src.y1;
	...
	public RectangularImpl(java.awt.Rectangle src)
	{
		this.x1 = src.x;
    ...
    public void copy(RectangularImpl src)
    {
        this.x1 = src.x1;
        this.x2 = src.x2;
        this.y1 = src.y1;
    ...
    {
        if (obj instanceof RectangularImpl)
        {
            RectangularImpl r = (RectangularImpl) obj;
     ...
     */
    public boolean encloses(RectangularImpl other)
    {
        return x1 <= other.x1 &&
               y1 <= other.y1 &&
               x2 >= other.x2 &&
	...
	public boolean intersects(RectangularImpl other)
	{
	    return !(other.x1 > x2 
    			|| other.x2 < x1 
    			|| other.y1 > y2 
    ...
    public RectangularImpl intersection(RectangularImpl other)
    {
    	if (this.intersects(other))
	    {
    		return new RectangularImpl(Math.max(x1, other.x1),
	    ...
	    {
	        return new RectangularImpl(); //an empty rectangle
	    }    	
    }
     ...
     */
    public RectangularImpl replaceX(RectangularImpl other)
    {
        RectangularImpl ret = new RectangularImpl(this);
        ret.x1 = other.x1;
        ret.x2 = other.x2;
        return ret;
    }
     ...
     * @return the resulting rectangle
     */
    public RectangularImpl replaceY(RectangularImpl other)
    {
        RectangularImpl ret = new RectangularImpl(this);
        ret.y1 = other.y1;
        ret.y2 = other.y2;
     ...
     */
    public RectangularImpl hsplit(RectangularImpl other)
    {
        if (this.intersects(other))
        {
            RectangularImpl a = new RectangularImpl(this);
            RectangularImpl b = new RectangularImpl(this);
     ...
     * @return if this rectangle had to be split in two parts, the second one is returned. Otherwise, null is returned.
     */
    public RectangularImpl vsplit(RectangularImpl other)
    {
        if (this.intersects(other))
        {
            RectangularImpl a = new RectangularImpl(this);
    ...
    public void expandToEnclose(RectangularImpl other)
    {
